	...
	<jsp:include page="header.jsp" />
	 <section id="page-header" class="blog-header">
        ...
        <section id="blog">
            <div class="blog-box">
                <div class="blog-img">
                    <img src="${pageContext.request.contextPath}/resources/img/blog/b1.jpg" alt="">
                </div>
            ...
            <div class="blog-box">
                <div class="blog-img">
                    <img src="${pageContext.request.contextPath}/resources/img/blog/b2.jpg" alt="">
                </div>
                <div class="blog-details">
            ...
            <div class="blog-box">
                <div class="blog-img">
                    <img src="${pageContext.request.contextPath}/resources/img/blog/b3.jpg" alt="">
                </div>
                <div class="blog-details">
            ...
            <div class="blog-box">
                <div class="blog-img">
                    <img src="${pageContext.request.contextPath}/resources/img/blog/b4.jpg" alt="">
                </div>
                <div class="blog-details">
            ...
            <div class="blog-box">
                <div class="blog-img">
                    <img src="${pageContext.request.contextPath}/resources/img/blog/b6.jpg" alt="">
                </div>
                <div class="blog-details">
